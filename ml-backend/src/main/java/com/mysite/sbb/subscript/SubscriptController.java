...
public class SubscriptController {
    ...
    public String showSubscripts(Model model, @RequestParam(value = "page", defaultValue = "1") int page) {
        String serviceKey = lhApiKey;
        int pageSize = 10;
        Page<Subscript> paging = subscriptService.fetchSubscripts(serviceKey, pageSize, page);
